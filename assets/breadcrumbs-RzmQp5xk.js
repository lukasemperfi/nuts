const u={catalog:"Магазин",product:"Карточка товара",production:"О производстве"},h=(o,i="")=>{const t=document.querySelector(o);if(!t)return;console.log("mode","production");const n="/nuts/",a=window.location.pathname.split("/").filter(Boolean);a[0]===n&&a.shift();let c=n;const l=`
