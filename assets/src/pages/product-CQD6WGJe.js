import{g as f,a as b,i as C,b as y,l as $}from"../../footer-BnmDAafM.js";import{i as L}from"../../breadcrumbs-Bdl_gLzY.js";import{i as P,N as x}from"../../navigation-DOgKByzg.js";import{i as M}from"../../tabs-D16X6BcN.js";const B=()=>{L(".product-page-breadcrumbs__container","breadcrumbs_color_muted")};function D(i,e){if(!i||Object.keys(i).length===0){console.warn("⚠️ renderProductDetailsCard: пустой или неверный объект product");return}console.log("Rendering product details card:",i,e);const t=document.querySelector(e),s=H(i);t.innerHTML="",t.appendChild(s)}function H(i){const{product_images:e,title:t,sku:s,subtitle:p,composition:n,energy_value:l,energy_unit:_,shelf_life_days:u,storage_conditions:v,weight:g,weight_unit:w,packaging_types:T,discount_price:c,price:h,price_unit:d,product_statuses:V}=i,m=e?.sort((a,o)=>a.sort_order-o.sort_order),r=document.createElement("div");return r.className="product-details-card",r.innerHTML=`
                    ...
                    ${m.map((a,o)=>`
                        <div class="swiper-slide">
                            <picture>
                                ...
                                <img class="product-details-card-swiper__image" src="${a.image_path_png}" loading="eager" alt="image-${o}" fetchpriority="high">
                            </picture>           
                        </div>
                    `).join("")}
              </div>
  ...
  <div class="product-details-card__col-2">
              ...
              <div class="info__price price">
                <span class="price__label">Ваша цена:</span>
                    <span class="price__value">
                        ${c!==null?`<span class="price__current-price">
                                <span class="price-number">${c}</span>&nbsp;${d}.
                            </span>`:""}
                            <span class="${c!==null?"price__old-price":"price__current-price"}">
    ...
    `},z=i=>{D(i,".product-content__card .page-container"),Z(".tabs__panel-product-tabs-1",i.description),q()};document.addEventListener("DOMContentLoaded",async()=>{const e=new URLSearchParams(window.location.search).get("id"),t=await f(e);b(),C({selector:".top-header__lang"}),B(),z(t),y(),$(".lazy",{rootMargin:"200px 0px"})});
