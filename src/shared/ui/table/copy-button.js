export class CopyButton {
  ...
  constructor(
    ...
    ariaLabel = "Скопировать строку"
  ) {
    this.#rowData = rowData;
    this.#element = this.#createButton(ariaLabel);
...
`;
    ...
    this.#element.addEventListener("click", this.#handleCopy);
  }

  #createButton(ariaLabel) {
  ...
  #handleCopy = async () => {
    const copyText = this.#formatRowData(this.#rowData);
  ...
  #formatRowData(data) {
    ...
    return Object.entries(dataToCopy)
  ...
  #showFeedback(success) {
    if (success) {
      ...
      this.#element.innerHTML = "✖";
      this.#element.classList.add("copy-fail");
    }

    setTimeout(() => {
      this.#element.innerHTML = this.#iconSvg;

      this.#element.classList.remove("copy-success", "copy-fail");
    }, 1500);
  }
